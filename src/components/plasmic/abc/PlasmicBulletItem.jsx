...
import Bullet from "../../Bullet"; // plasmic-import: g-IwhhK4FNntL/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic_abc.module.css"; // plasmic-import: 3zC4fkbXrqgM7fa4uUQ6gc/projectcss
import sty from "./PlasmicBulletItem.module.css"; // plasmic-import: sOkDWM3QbSqcr/css
...
function PlasmicBulletItem__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__oWf29)}>
        <div className={classNames(projectcss.all, sty.freeBox__rNtfP)}>
          {p.renderPlasmicSlot({
            defaultContents:
