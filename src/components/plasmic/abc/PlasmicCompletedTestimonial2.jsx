...
import sty from "./PlasmicCompletedTestimonial2.module.css"; // plasmic-import: KPvfscqbuo6iJ/css
...
function PlasmicCompletedTestimonial2__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__txaCs)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__jZs6V)}
              displayHeight={"100px"}
      ...
      <div className={classNames(projectcss.all, sty.freeBox__aa7Vd)}>
        <div className={classNames(projectcss.all, sty.freeBox___6CGsE)}>
          {p.renderPlasmicSlot({
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___9KQbG)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__jqPpf)}>
          {p.renderPlasmicSlot({
