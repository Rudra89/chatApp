...
import sty from "./PlasmicButton.module.css"; // plasmic-import: dg5hG6WfqSe6w/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: XfnfbWI_67LAC/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__yp8U)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mwDiK)}
                role={"img"}
              />
            ),
